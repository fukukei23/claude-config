...
├── CLAUDE.md                    ← LLM優先ルール
├── ルーティング.md                   ← ルーティング詳細設定
├── トラブルシューティング.md           ← FAQ・トラブル解決
│
...
| LLMが遅い・失敗する | `ルーティング.md` | ルーティング詳細やフォールバック設定を確認 |
| トラブル発生時 | `トラブルシューティング.md` | FAQ・よくあるエラーパターン |
...
| Desktop LLM が全て失敗した | `フォールバック.md` | WSL2 側の Fallback 戦略確認 |
...
- [ ] **LLMルーティング確認** → `設定戦略.md` を参照
- [ ] **トラブル時** → `claude-config/トラブルシューティング.md` を確認
- [ ] **新プロジェクト開始** → `claude-config/projects/` でテンプレート探索

### ✅ トラブル時

- [ ] **Desktop LLM が遅い** → `ルーティング.md` でフォールバック確認
- [ ] **すべての LLM が失敗** → WSL2 Fallback (`krokod-setup/フォールバック.md`)
...
**A**: `claude-config/README.md` → `設定戦略.md` → `CLAUDE.md` の順
...
**A**: `krokod-setup/フォールバック.md` で WSL2 セットアップ検討
...
| 問題 | 確認先 |
|-----|-------|
| LLM ルーティング | `設定戦略.md` + `CLAUDE.md` |
| 設定テンプレート | `claude-config/core/` |
| WSL2 環境 | `krokod-setup/README.md` |
| トラブルシューティング | `claude-config/トラブルシューティング.md` |
