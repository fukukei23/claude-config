...
> 📖 **story提案（2026-09-06追加・1回だけ）**: 開始前に自問「本セッションに物語に値する作業（新仕様/事故解決/反復解消/スキル作成改修）があったか？」→ ありなら **story スキルの発動を1回だけ提案**してから以下へ進む（cron id=19が拾うまで2日空くため・alert fatigue回避の1回限り）。
