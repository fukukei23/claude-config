...
cp scripts/*.sh scripts/*.ps1 ~/.claude/scripts/
...
```bash
# スクリーンショット撮影
~/.claude/scripts/take-screenshot.sh

# カーソル位置取得
~/.claude/scripts/get-cursor.sh
```
...
**Related**: [obsidian-logging](https://github.com/fukukei23/claude-config/tree/main/obsidian-logging) - Claude Code作業の自動ログ保存
